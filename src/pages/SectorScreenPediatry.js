import {
  ...
  NavBarSide,
  SectorSide,
} from "../styles/HomeAndSectorGrid.js";
...
const SectorScreenPediatry = ({ active }) => {
  const {
    showPopUpAdd,
    showPopUpStatus,
    showPopUpDeletar,
  ...
  return (
    <>
      ...
      <HomeContainer
        active={showPopUpAdd}
        active2={showPopUpStatus}
        active4={showPopUpDeletar}
        active5={showPopUpSuccessfully}
        active6={showPopUpVacate}
        active7={showPopUpSucessfullyCreated}
        active8={showPopUpOccupied}
        active9={showPopUpSuccesfullyDeleted}
        active10={showPopUpSuccessfullyAvaible}
        active11={showPopUpViewInfoPatient}
        active12={showPopUpSuccessfullyUpdatedInfo}
      >
...
export default SectorScreenPediatry;
