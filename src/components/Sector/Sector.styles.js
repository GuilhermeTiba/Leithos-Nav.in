...
export const PopUp = styled.div`
  ...
  bottom: 0;
  margin: auto;
  height: ${({ active2 }) => (active2 ? "525px" : "285px")};
...
export const PopUpCreateStatus = styled.button`
  width: 150px;
  background: #6045e2 0% 0% no-repeat padding-box;
  border: none;
  border-radius: 8px;
...
export const PopUpCancelStatus = styled.button`
  width: 150px;
  background: #ffffff 0% 0% no-repeat padding-box;
  border: 1px solid #6045e2;
  border-radius: 8px;
...
export const PopUpCreatePatientInfo = styled.button`
  width: 170px;
  background: #6045e2 0% 0% no-repeat padding-box;
  border: none;
  border-radius: 8px;
...
export const PopUpCancelPatientInfo = styled.button`
  width: 170px;
  background: #ffffff 0% 0% no-repeat padding-box;
  border: 1px solid #6045e2;
  border-radius: 8px;
