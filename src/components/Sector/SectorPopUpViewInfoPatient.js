                    ...
                    return(
                        <PopUpPatientInfo active2={showPopUpViewInfoPatient}>
                            <PopUpWrappPatientInfo>
                                ...
                                <PopUpIconPencil onClick={handleClickPencil}><FiEdit/></PopUpIconPencil>
                                <PopUpFormPatientInfo>
                                    <PopUpFieldPatientInfo>
                                        <PopUpLabel>Nome do paciente</PopUpLabel>
                                        <PopUpLabelInfo toggle={toggle}>{patient.patientName}</PopUpLabelInfo>
                                        <PopUpInputInfo toggle={toggle} type='text' value={namePatient} onChange={(e) => setNamePatient(e.target.value)}/>
                                    </PopUpFieldPatientInfo>
                                    ...
                                    <PopUpFieldPatientInfo>
                                        <SexAgeWrapp>
                                            <SexWrapp>
                                                ...
                                                <PopUpLabelInfo toggle={toggle}>{patient.patientSexo}</PopUpLabelInfo>
                                                <PopUpInputSelectInfo toggle={toggle} value={sexPatient} onChange={(e) => setSexPatient(e.target.value)}>
                                            ...
                                            <AgeWrapp>
                                                ...
                                                <PopUpLabelInfo toggle={toggle}>{patient.age}</PopUpLabelInfo>
                                                <PopUpInputInfo toggle={toggle} type='text' value={agePatient} onChange={(e) => setAgePatient(e.target.value)}/>
                                            </AgeWrapp>
                                        </SexAgeWrapp>
                                    </PopUpFieldPatientInfo>
                                    ...
                                    <PopUpFieldPatientInfo>
                                        ...
                                        <PopUpLabelInfo toggle={toggle}>{patient.diagnosis}</PopUpLabelInfo>
                                        <PopUpInputSelectInfo toggle={toggle} value={diagnosisPatient} onChange={(e) => setDiagnosisPatient(e.target.value)}>
                                            <SelectOption selected></SelectOption>
                                ...
                                <PopUpButtonsPatientInfoView2 toggle={toggle}>
                                    <PopUpCancel onClick={handleClickPencil}>Cancelar</PopUpCancel>
