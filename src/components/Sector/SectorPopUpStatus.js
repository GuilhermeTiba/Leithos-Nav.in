      ...
      <PopUpWrapp>
        ...
        <PopUpForm>
          <PopUpField>
            {dataLeito.status === "Ocupado" ? (
              <>
                ...
                <PopUpButton onClick={handleUpdateDisponivel}>
                  Disponível
                </PopUpButton>
                <PopUpButton onClick={handleUpdateEmManu}>
                  Leito em manutenção
                </PopUpButton>
                <PopUpButton onClick={handleUpdateAguardManu}>
                  Aguardando manutenção
                </PopUpButton>
                <PopUpButton onClick={handleUpdateEmLimp}>
                  Leito em limpeza
                </PopUpButton>
                <PopUpButton onClick={handleUpdateAguardLimp}>
                  Aguardando limpeza
                </PopUpButton>
              </>
            ) : (
            ...
            {dataLeito.status === "Disponível" ? (
              <>
                <PopUpButton onClick={handleUpdateOcupado}>
                  Reservar leito
                </PopUpButton>
                <PopUpLabel>Atualizar status:</PopUpLabel>
                <PopUpButton onClick={handleUpdateEmManu}>
          ...
          <PopUpField>
            ...
            <PopUpField>
              <PopUpButton onClick={handleChangeInfo}>
                Alterar informações
              </PopUpButton>
        ...
        <PopUpButtons>
          ...
          <PopUpCreateStatus onClick={handleSave}>Salvar</PopUpCreateStatus>
        </PopUpButtons>
      </PopUpWrapp>
    </PopUp>
  );
